...
const patchNotesData: PatchNote[] = [
  {
    version: "1.2.0",
    date: "2025-8-9",
    title: "Боковое меню навигации и забавный loading state",
    description: "Добавлено профессиональное боковое меню с навигацией по всем разделам приложения. Включает возможность скрытия/показа меню, адаптивный дизайн для мобильных устройств и автоматическое закрытие на мобильных устройствах при переходе между страницами. Также добавлен забавный loading state с покерными анимациями при переходе между страницами.",
    type: "feature",
    priority: "high",
    affectedAreas: ["Навигация", "Пользовательский интерфейс", "Мобильная версия", "Удобство использования", "Loading состояния"],
    show: true
  },
  {
    version: "1.1.4",
